...
//       <Router>
//         <Routes>
//           <Route path="/create-class" Component={AdminClass} />
//           <Route path="/create-student" Component={AdminStudent} />
//           <Route path="/create-course" Component={AdminCourse} />
//           <Route path="/students" Component={Students} />
//           <Route path="/classes" Component={Classes} />
//           <Route path="/class/update/:slug" Component={UpdateClass} />
//           <Route path="/student/update/:slug" Component={UpdateStudent} />
//           <Route path="/course/update/:slug" Component={UpdateCourse} />
//           <Route path="/about-course/:slug" Component={ViewCourse} />
//           <Route path="/about-class/:slug" Component={ViewClass} />
//           <Route path="/student/:slug" Component={ViewStudent} />
